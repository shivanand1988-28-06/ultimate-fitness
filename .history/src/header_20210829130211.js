...
const history = useHistory();
    ...
    return(
        ...
        <MDBBtn  outline rounded color='danger' onClick = {()=>history.push('/signin')} >SIGN IN</MDBBtn></div><MDBIcon size='2x'fas icon="shopping-cart" /></Bounce>{userSignup.username}
    </div>
