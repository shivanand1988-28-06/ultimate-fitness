...
import './modal';
import { PriceContext , SetPriceContext } from './App';
...
const UploadForm = () => {
  ...
  const types = ['image/png', 'image/jpeg'];
   ...
   const DataPrice = useContext(PriceContext);
  const GivePrice = useContext(SetPriceContext);
  ...
  console.log({DataPrice, GivePrice})
