...
function SignUp(){
 ...
 function handleSubmit(e){
     ...
     try{ const userDataBase = userAuth.createUserWithEmailAndPassword( userSignup.email, userSignup.password)} 
    catch(error){return(<h2>{error}</h2>)};
     console.log(userDataBase,reCord);
        // .then((userCredential) => {
        //   // Signed in 
