...
import {userAuth, projectStorage, projectFirestore} from "./firebase" ;

function SignUp(){

  const userDetailsRef =  projectFirestore.collection("userdetails");
...
<input type = "number" className = "signform" name = "mobilenumber" value = {userSignup.mobilenumber} autoComplete = "off" onChange = {handleInput}/><br></br>
</div>
