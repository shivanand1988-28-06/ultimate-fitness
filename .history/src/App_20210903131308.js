...
function App(){
  ...
  <div>
     ...
     <Switch>
        ...
        <Route exact path= "/mycart" currentUser = {currentUser} component = { Cart }/>
        <Route history = {history} exact path = '/signup'  component ={ SignUp }/>
        <Route history = {history} exact path = '/signin'  component ={ SignIn }/>
        <Route  exact path = '/header' currentUser = {currentUser} > <Header/> </Route>
        <Route   history = {history} currentUser = {currentUser} exact path = '/products' ><Products/></Route>
